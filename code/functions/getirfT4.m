function [ irx1,irx2,irx3,irx4,...
    ...
    fd1,fd2,fd3,fd4,fd5,fd6,fd7,fd8] = getirfT4( L,LH,LV,N,horizon1,Fmat,Qmat,varcoef,iamat,REPSx,Y,hlast,FF)
irx1=0;
irx2=0;
irx3=0;
irx4=0;
...
H0=hlast(hh(j)-LV+1:hh(j),1:N);
 ...
 [ir1,ir2,ir3,ir4,hir1,hir2,hir3,hir4,...
    ...
    getlevelirfFMCnew4( L,LH,LV,N,horizon1,Fmat,Qmat,varcoef,iamat,A0,REPSx,Y0,H0,FF);
...
[ir1v,ir2v,ir3v,ir4v,hir1v,hir2v,hir3v,hir4v,...
    ...
    getvolirfFMCnew4( L,LH,LV,N,horizon1,Fmat,Qmat,varcoef,iamat,A0,REPSx,Y0,H0,FF);
