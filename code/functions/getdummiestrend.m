function [yd,xd,b0,s0]=getdummiestrend(LAMDAPEVIEWS,TAUPEVIEWS,EPSILONPEVIEWS,...
    EPST,Y,L,EX,LH,EPSILONH,EPSILONH0,RW)
N=cols(Y);
...
[yd,xd] = create_dummiesT(lamdaP,tauP,deltaP,epsilonP,epsilonT,...
    L,muP,sigmaP,N,LH,epsilonH,epsilonH0);
% size(yd)
% size(xd)
b0=vec(xd\yd);
