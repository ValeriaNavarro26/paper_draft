function [hh,hhh,hh1,hh2]=plotx5(t,y)
...
hhh=fill([h(1); h(1:end); flipud([h(1:end); h(end)])],[du(1); dl(1:end); flipud([du(1:end); dl(size(cl,1))])],'b');
set(hhh,'edgecolor',[1 0.90 0.90]);
set(hhh,'facecolor',[1 0.90 0.90]);
hold on
